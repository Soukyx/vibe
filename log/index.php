...
<body class="bg-white">
    <nav id="nav" class="navbar navbar-expand-md navbar-dark bg-white">
      ...
      <div id="demo" class="carousel slide text-center" data-ride="carousel">
        ...
        <div class="carousel-inner img-fluid cover align-top">
          <div class="carousel-item active img-fluid top">
            <img style="max-height: 100%; max-width: 100%;" src="https://www.usmagazine.com/wp-content/uploads/2020/08/Breaking-Bad-Where-Are-They-Now.jpg?w=1600&quality=86&strip=all" alt="">
          <div id="cover" class="carousel-caption"><a id="car" href="#">New Breaking Bad Collection</a></div>
          </div>
      ...
      <div class="row bg-white text-center" style="padding:20px; margin: 0px;">
<h2>BRAND NEW CLOTHES</h2>
    ...
    <div class="col-md-3 col-sm-6">
      ...
      <!-- Footer -->
<footer class="page-footer font-small teal pt-4 bg-black text-white">
  ...
  <div class="container-fluid text-center text-md-left">
    ...
    <div class="row">
      ...
      <div class="col-md-4 mb-md-0 mb-3 text-center">
        ...
        <h4 href="#" class="fa fa-facebook bg-white text-black" ></h4>
        <h4 href="#" class="fa fa-twitter bg-white text-black"></h4>
        <h4 href="#" class="fa fa-instagram bg-white text-black"></h4>
  ...
  <!-- Copyright -->
  <div id="footera" class="footer-copyright text-center py-3 text-white">© 2022 Copyright:
    <a href="https://github.com/Soukyx" class="text-white">Soukyx</a>
  </div>
  <!-- Copyright -->
